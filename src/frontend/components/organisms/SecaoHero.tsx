...
import { BotaoRolagemSuave } from "@/frontend/components/molecules/BotaoRolagemSuave";

export function SecaoHero() {
  return (
    <section className="relative overflow-hidden px-4 py-20 sm:px-6 sm:py-28">
      <div className="pointer-events-none absolute inset-0 bg-gradient-to-br from-indigo-50 via-white to-violet-50 dark:from-indigo-950/30 dark:via-zinc-950 dark:to-violet-950/30" />
